...
_GENERAL_TEXT: Dict[str, Dict[str, str]] = {
    "zh": {
        ...
        "notif_channel_pushover": "Pushover",
        "notif_channel_ntfy": "ntfy",
        "notif_channel_gotify": "Gotify",
        "notif_channel_pushplus": "PushPlus",
        "notif_channel_serverchan3": "Server酱3",
        "notif_channel_custom": "自定义Webhook",
        "notif_channel_discord": "Discord机器人",
        "notif_channel_astrbot": "ASTRBOT机器人",
        "notif_channel_dingtalk": "钉钉会话",
        "notif_channel_feishu_session": "飞书会话",
        "notif_channel_unknown": "未知渠道",
        "notif_no_channels": "未配置有效的通知渠道，将不发送推送通知",
        "notif_channels_configured": "已配置 {} 个通知渠道：{}",
        "notif_send_success": "通知发送成功 ({})",
        "notif_send_failure": "通知发送失败 ({}): {}",
        "notif_channel_disabled": "通知渠道已禁用: {}",
    ...
    "en": {
        ...
        "notif_channel_gotify": "Gotify",
        "notif_channel_pushplus": "PushPlus",
        "notif_channel_serverchan3": "ServerChan3",
        "notif_channel_custom": "Custom Webhook",
        "notif_channel_discord": "Discord Bot",
        "notif_channel_astrbot": "AstrBot",
        "notif_channel_dingtalk": "DingTalk Session",
        "notif_channel_feishu_session": "Feishu Session",
        "notif_channel_unknown": "Unknown",
        "notif_no_channels": "No valid notification channels configured, notifications will not be sent",
        "notif_channels_configured": "{} notification channels configured: {}",
        "notif_send_success": "Notification sent ({})",
        "notif_send_failure": "Notification failed ({}): {}",
        "notif_channel_disabled": "Notification channel disabled: {}",
